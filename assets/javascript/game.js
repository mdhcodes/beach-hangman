...
var setUpGame = function() {
    ...
    for (var i = 0; i < randomWord.length; i++) {
        ...
        beachWord.push('<div class="letters">' + randomWord[i] + '</div> ');
...
var playGame = function() {
    ...
    document.addEventListener('keyup', function release(event) {
        ...
        if (keyUpLower.match(lowerLettersOnly)) {
            ...
            if (randomWord.indexOf(keyUpLower) === -1 && alreadyGuessedLetters.indexOf(keyUpLower) === -1) {
            ...
            if (lettersVisible === randomWord.length && numOfGuesses > 0) {
            ...
            if (numOfGuesses === 0 && lettersVisible !== randomWord.length) {
                startOver = true;
